...
class cLaporan extends CI_Controller
{
	...
	public function lap_harian_transaksi()
	{
		...
		$pdf->Cell(200, 10, 'LAPORAN HASIL TRANSAKSI HARIAN', 0, 1, 'C');
		$pdf->Cell(200, 10, 'KIM - CLINIC', 0, 0, 'C');
		$pdf->SetLineWidth(0);
		$pdf->Cell(10, 30, '', 0, 1);
	...
	public function lap_bulanan_transaksi()
	{
		...
		$pdf->Cell(200, 10, 'LAPORAN HASIL TRANSAKSI BULANAN', 0, 1, 'C');
		$pdf->Cell(200, 10, 'KIM - CLINIC', 0, 0, 'C');
		$pdf->SetLineWidth(0);
		$pdf->Cell(10, 30, '', 0, 1);
		$pdf->SetFont('Times', 'B', 9);
	...
	public function lap_tahunan_transaksi()
	{
		...
		$pdf->Cell(200, 10, 'LAPORAN HASIL TRANSAKSI TAHUNAN', 0, 1, 'C');
		$pdf->Cell(200, 10, 'KIM - CLINIC', 0, 0, 'C');
		$pdf->SetLineWidth(0);
		$pdf->Cell(10, 30, '', 0, 1);
		$pdf->SetFont('Times', 'B', 9);
