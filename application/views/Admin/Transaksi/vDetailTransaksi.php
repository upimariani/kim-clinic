							...
							<tbody>
								...
								?>
									<tr>
										...
										<td class="text-right">Rp.<?= number_format($value->harga  *  $value->qty) ?></td>
									</tr>
								<?php
								}
								?>
								...
								<tr>
									...
									<th>&nbsp;</th>
									<th>Subtotal </th>
									<th class="text-right">Rp. <?= number_format($detail['transaksi']->tot_transaksi)  ?></th>
								</tr>
								<tr>
									<th>&nbsp;</th>
									<th>&nbsp;</th>
								...
								<tr>
									...
									<th>&nbsp;</th>
									<th>Total </th>
									<th class="text-right">Rp. <?= number_format($detail['transaksi']->tot_transaksi + $detail['transaksi']->ongkir)  ?></th>
								</tr>
							</tbody>
						</table>
