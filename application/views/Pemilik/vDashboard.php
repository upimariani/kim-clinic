<div class="main-panel">
	<div class="content-wrapper">
		...
		$jumlah_member = $this->db->query("SELECT COUNT(id_pelanggan) as jml_pelanggan FROM `pelanggan` WHERE level_member='0'")->row();
		$jumlah_nonmember = $this->db->query("SELECT COUNT(id_pelanggan) as jml_pelanggan FROM `pelanggan` WHERE level_member='1'")->row();
		?>
					...
					<div class="card-body px-3 py-4">
						<div class="d-flex justify-content-between align-items-start">
							<div class="color-card">
								...
								<h2 class="text-white"> <?= $jumlah_member->jml_pelanggan ?> <span class="h5"> pelanggan</span>
								</h2>
							</div>
					...
					<div class="card-body px-3 py-4">
						<div class="d-flex justify-content-between align-items-start">
							<div class="color-card">
								...
								<h2 class="text-white"> <?= $jumlah_nonmember->jml_pelanggan ?> <span class="h5"> pelanggan</span>
								</h2>
							</div>
